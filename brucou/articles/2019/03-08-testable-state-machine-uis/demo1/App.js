                          ...
                          .map(result =>
                            li('.uk-margin-bottom', { key: result.id }, [
                              a(
                                ...
                                {
                                  href: '#',
                                  onClick: domEventHandlers[MOVIE_SELECTED](
                                    result,
                                  ),
                                  'data-id': result.id,
                                },
  ...
  SEARCH_RESULTS_WITH_MOVIE_DETAILS: (results, query, details, cast) =>
    div(
      ...
      [
        div(
          '.App__view-container',
          { onClick: domEventHandlers[MOVIE_DETAILS_DESELECTED] },
          [
            div(
              '.App__view.uk-margin-top-small.uk-margin-left.uk-margin-right',
              { 'data-page': 'home' },
...
const domEventHandlers = {
  ...
  [MOVIE_SELECTED]: movieDetail => ev =>
    eventEmitter.emit(MOVIE_SELECTED, movieDetail),
...
function handleAppEvents(app, event, args) {
  ...
  const { queryFieldHasChanged, movieQuery, results, movieTitle } = app.state
  ...
  switch (event) {
    ...
    case SEARCH_RESULTS_RECEIVED:
      ...
      if (queryFieldHasChanged === false) {
        app.setState({
          screen: screens.SEARCH_RESULTS_SCREEN(searchResults, ''),
          results: searchResults,
        })
      } else if (queryFieldHasChanged === true) {
        app.setState({
          screen: screens.SEARCH_RESULTS_SCREEN(searchResults, movieQuery),
          results: searchResults,
        })
      }
      break
    ...
    case MOVIE_SELECTED:
      ...
      // TODO update S8-11 (title)
      app.setState({
        screen: screens.SEARCH_RESULTS_WITH_MOVIE_DETAILS_AND_LOADING_SCREEN(
          results,
          movieQuery,
          movie,
        ),
      ...
      Promise.all([
        ...
        .then(([details, cast]) =>
          eventEmitter.emit(SEARCH_RESULTS_MOVIE_RECEIVED, details, cast),
        )
    ...
    case SEARCH_RESULTS_MOVIE_RECEIVED:
      ...
      app.setState({
        screen: screens.SEARCH_RESULTS_WITH_MOVIE_DETAILS(
          results,
          movieQuery,
          movieDetails,
          cast,
    ...
    case SEARCH_ERROR_MOVIE_RECEIVED:
      app.setState({
        screen: screens.SEARCH_RESULTS_WITH_MOVIE_DETAILS_ERROR(
          results,
          movieQuery,
          movieDetails,
          movieTitle,
...
class App extends Component {
  constructor(props) {
    ...
    Object.keys(events).forEach(ev =>
      eventEmitter.on(ev, (...args) => handleAppEvents(app, ev, args)),
    )
  }
