...
Let's investigate the catch by diving into an example, before building some intuition around when to use hooks -- and when to use something else.
...
- The status of any drag-and-drop interfactions (e.g. [react-dnd](https://github.com/react-dnd/react-dnd))
